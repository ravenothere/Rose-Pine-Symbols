...
[Symbols](https://github.com/miguelsolorio/vscode-symbols)' file type coverage, recolored with the Rosé Pine palette — with Rosé Pine's folder style built right in.
...
![Preview of extension](https://raw.githubusercontent.com/ravenothere/rose-pine-symbols/main/preview.png)

</div>

## Installation
Available on:
- **[Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ravenothere.rose-pine-symbols)**
...
| folder-aws | ![folder-aws](preview/folders/folder-aws.png) |
| folder-azure | ![folder-azure](preview/folders/folder-azure.png) |
...
| folder-build | ![folder-build](preview/folders/folder-build.png) |
| folder-config | ![folder-config](preview/folders/folder-config.png) |
| folder-constants | ![folder-constants](preview/folders/folder-constants.png) |
...
| folder-docker | ![folder-docker](preview/folders/folder-docker.png) |
| folder-documents | ![folder-documents](preview/folders/folder-documents.png) |
...
| folder-expo | ![folder-expo](preview/folders/folder-expo.png) |
...
| folder-fonts | ![folder-fonts](preview/folders/folder-fonts.png) |
| folder-github | ![folder-github](preview/folders/folder-github.png) |
| folder-gitlab | ![folder-gitlab](preview/folders/folder-gitlab.png) |
| folder-graphql | ![folder-graphql](preview/folders/folder-graphql.png) |
...
| folder-hooks | ![folder-hooks](preview/folders/folder-hooks.png) |
| folder-i18n | ![folder-i18n](preview/folders/folder-i18n.png) |
...
| folder-interfaces | ![folder-interfaces](preview/folders/folder-interfaces.png) |
| folder-ios | ![folder-ios](preview/folders/folder-ios.png) |
| folder-js | ![folder-js](preview/folders/folder-js.png) |
| folder-layout | ![folder-layout](preview/folders/folder-layout.png) |
| folder-lock | ![folder-lock](preview/folders/folder-lock.png) |
...
| folder-mongo | ![folder-mongo](preview/folders/folder-mongo.png) |
| folder-nginx | ![folder-nginx](preview/folders/folder-nginx.png) |
| folder-node-modules | ![folder-node-modules](preview/folders/folder-node-modules.png) |
...
| folder-pink | ![folder-pink](preview/folders/folder-pink.png) |
| folder-pink-outline | ![folder-pink-outline](preview/folders/folder-pink-outline.png) |
...
| folder-react | ![folder-react](preview/folders/folder-react.png) |
...
| folder-redis | ![folder-redis](preview/folders/folder-redis.png) |
...
| folder-sass | ![folder-sass](preview/folders/folder-sass.png) |
...
| angular-directive | ![angular-directive](preview/files/angular-directive.png) |
| angular-guard | ![angular-guard](preview/files/angular-guard.png) |
| angular-module | ![angular-module](preview/files/angular-module.png) |
| angular-pipe | ![angular-pipe](preview/files/angular-pipe.png) |
...
| brackets-pink | ![brackets-pink](preview/files/brackets-pink.png) |
...
| claude | ![claude](preview/files/claude.png) |
...
| gitlab | ![gitlab](preview/files/gitlab.png) |
...
| json | ![json](preview/files/gear.png) |
